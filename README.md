...
0. 直接创建一个eva.py并把本仓库的eva.py文本内容粘贴进去（docker环境、运维环境等也很容易粘贴代码）。当然，你也可以git clone本仓库

1. 修改代码中的`VLLM_BASE_URL`, `MODEL_NAME`, `API_KEY`变量为你自己的OpenAI接口，可以是vllm拉起的本地服务、deepseek官网接口等
