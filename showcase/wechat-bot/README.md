...
微信官方通过 iLink 协议来对接ClawBot，也对接对接其他自定义机器人。

wechatbot则是一个已封装好 iLink 协议的python库，说明文档：https://www.wechatbot.dev/en/python


## 给EVA配的hints.md

我的各种信息以及笔记都记在Obsidian里，我希望EVA能帮我检索这些内容，尤其各种杂乱的账号密码。
此外，Tavily可以让EVA具备联网检索功能。我给EVA配的`hints.md`内容如下（`hints.md`参照EVA项目说明文档）：
